...
void CGameContext::RegisterDDRaceCommands()
{
	...
	Console()->Register("tele", "?i[id] ?i[id]", CFGFLAG_SERVER, ConTeleport, this, "Teleports player ID (self = -1) to player ID (self = -1)");
	...
	Console()->Register("shotgun", "?i[id]", CFGFLAG_SERVER, ConShotgun, this, "Gives a shotgun to you");
	...
	Console()->Register("freezehammer", "?v[id]", CFGFLAG_SERVER, ConFreezeHammer, this, "Gives a player Freeze Hammer");
...
void CGameContext::RegisterChatCommands()
{
	...
	// These Two Commands are dirty and cause alot of problems. I dont like them.
