...
class CConsole : public IConsole
{
	...
	public:
		...
		void SetAccessLevel(int AccessLevel) { m_AccessLevel = clamp(AccessLevel, (int)(ACCESS_LEVEL_OWNER), (int)(ACCESS_LEVEL_USER)); }
	};
...
public:
	...
	void SetAccessLevel(int AccessLevel) override { m_AccessLevel = clamp(AccessLevel, (int)(ACCESS_LEVEL_OWNER), (int)(ACCESS_LEVEL_USER)); }
